...
void transferData() {
    ...
    if(sleepEnabledFlag[0] == 1) {
        ...
        TX_buffer[(0*ROBOT_PACKET_SIZE)+19] = (robotAddress[currPacketId*4+0]>>8)&0xFF;     // address of the robot
        TX_buffer[(0*ROBOT_PACKET_SIZE)+20] = robotAddress[currPacketId*4+0]&0xFF;
    } else {
    ...
    if(sleepEnabledFlag[1] == 1) {
        ...
        TX_buffer[(1*ROBOT_PACKET_SIZE)+19] = ((robotAddress[currPacketId*4+1])>>8)&0xFF; // address of the robot
        TX_buffer[(1*ROBOT_PACKET_SIZE)+20] = (robotAddress[currPacketId*4+1])&0xFF;
    } else {
    ...
    if(sleepEnabledFlag[2] == 1) {
        ...
        TX_buffer[(2*ROBOT_PACKET_SIZE)+19] = ((robotAddress[currPacketId*4+2])>>8)&0xFF; // address of the robot
        TX_buffer[(2*ROBOT_PACKET_SIZE)+20] = (robotAddress[currPacketId*4+2])&0xFF;
    } else {
